...
lines = [
    ...
    "",
    "✅ <b>Tamamlanan:</b>",
    "  • P0-3: Kalite skoru 50+ hedefi",
    "  • P1-3: ASO ingest (785 kayit)",
    "  • P1-4: Multi-OSB merger (5756 firma)",
    "  • P1-7: VKN web kazima (pilot 2 tamam)",
    "  • P2-3: Zamanlanmış scrape scripti",
    "  • P2-4: Entity resolution threshold optimizasyonu",
    "",
    "🔄 <b>Devam eden:</b>",
    "  • P1-5: NACE eksikleri (684 firma kaldi)",
    "  • P1-1/P1-2: İvedik/Başkent (VPN engeli)",
    "",
