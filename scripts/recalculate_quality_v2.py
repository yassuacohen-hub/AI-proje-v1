#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""DB kalite skorlarini yeniden hesapla - gelistirilmis formul."""
import sys
        ...
        SELECT
            ...
            (
                ...
                + CASE WHEN COALESCE(c.tax_number, c.vergi_no, sr.raw_tax_number) IS NULL
                            OR COALESCE(c.tax_number, c.vergi_no, sr.raw_tax_number) = '' THEN -5 ELSE 0 END
                + CASE WHEN NOT sr.raw_payload ? :adres THEN -10 ELSE 0 END
