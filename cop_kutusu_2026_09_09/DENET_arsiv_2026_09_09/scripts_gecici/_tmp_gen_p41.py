...
ABBREVIATIONS = {
    "san.", "tic.", "ltd.", "�ti.", "a.�.", "a.s.", "anonim", "�irketi",
    "limited", "�irket", "ve", "ticaret", "sanayi", "imalat", "de�erleme",
    "organize", "av.", "tur.", "org.", "dan.", "kim.", "i�n�.", "in�.",
    "d��", "dis", "i�", "ic", "tekstil", "tek.", "imal", "ithalat", "ihracat",
    "m�hendislik", "m�h.", "muh.", "m��avir", "musavir", "hizmet", "hizm.",
    "g�da", "gida", "metal", "otomotiv", "otom.", "elektronik", "elektr.",
    "yaz�l�m", "yazilim", "teknoloji", "tekno.", "teknol.", "mobilya",
    "mob.", "tekstil", "tekst.", "tek.", "plastik", "kau�uk", "kaucuk",
    "�r�nler", "urunler", "�r�n", "urun", "imalat", "imal.", "de�erleme",
    "degerleme", "de�er.", "deger.",
}
...
def adim3_vkn_web_scrape(conn, limit: int = 50) -> dict:
    ...
    VKN_DESENLER = [
        re.compile(r'vergi\s*(?:no|numaras[�i])\s*[:\-�]?\s*([0-9]{10})', re.IGNORECASE),
...
def main() -> int:
    ...
    sonuc = {
        ...
        "analysis": {
            ...
            "next_steps": [
                "p43_ostim_vkn.py tamami calistir (eri�im varsa)",
